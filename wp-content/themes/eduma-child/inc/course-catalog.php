...
function eduma_child_legacy_course_catalog() {
	$assets = get_stylesheet_directory_uri() . '/assets/images/courses/';
	return array(
		'welding-and-fabrication' => array( 'title' => 'MIG/MAG Welding', 'short' => 'Build confident MIG/MAG welding technique through guided workshop practice and modern learning tools.', 'seo_title' => 'MIG/MAG Welding Training in Kenya | Toolkit Africa', 'seo_description' => 'Study practical MIG/MAG welding at Toolkit Africa in Kikuyu, Kenya, through guided workshop training, VR-supported learning, and instructor feedback.', 'image' => $assets . 'welding.jpg', 'icon' => 'fa-fire', 'url' => home_url( '/our-ventures/construction-sector-skills/' ), 'duration' => 'Contact admissions for the current schedule', 'intakes' => 'Confirmed by admissions', 'qualification' => 'Practical MIG/MAG welding training', 'examining' => 'Confirmed for the selected pathway', 'entry' => 'Admissions will advise based on the selected level', 'outcomes' => array( 'Workshop safety', 'MIG/MAG process setup', 'Weld technique and control', 'Quality-aware practical work' ) ),
		'renewable-energy' => array( 'title' => 'Renewable Energy', 'short' => 'Build technical foundations for solar and emerging green-skills opportunities.', 'image' => $assets . 'solar.jpg', 'icon' => 'fa-solar-panel', 'url' => home_url( '/our-ventures/renewable-energy/' ), 'duration' => 'Contact admissions for the current schedule', 'intakes' => 'Confirmed by admissions', 'qualification' => 'Renewable energy skills training', 'examining' => 'Confirmed for the selected pathway', 'entry' => 'Admissions will advise based on the selected level', 'outcomes' => array( 'Solar energy fundamentals', 'Safe installation practice', 'System testing', 'Green-skills career awareness' ) ),
		'organic-farming-skills' => array( 'title' => 'Organic Farming Skills', 'short' => 'Learn practical and sustainable approaches to agriculture and enterprise.', 'image' => $assets . 'experiences/organic-farm.jpg', 'icon' => 'fa-seedling', 'url' => home_url( '/our-ventures/organic-farming-skills/' ), 'duration' => 'Contact admissions for the current schedule', 'intakes' => 'Confirmed by admissions', 'qualification' => 'Practical organic farming skills training', 'examining' => 'Confirmed for the selected pathway', 'entry' => 'Contact admissions for current requirements', 'outcomes' => array( 'Sustainable crop production', 'Soil and resource care', 'Farm planning', 'Agricultural enterprise skills' ) ),
