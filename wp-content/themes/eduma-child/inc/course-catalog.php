...
function eduma_child_legacy_course_catalog() {
	$assets = get_stylesheet_directory_uri() . '/assets/images/courses/';
	return array(
		'welding-and-fabrication' => array( 'title' => 'MIG/MAG Welding', 'short' => 'Build confident MIG/MAG welding technique through guided workshop practice and modern learning tools.', 'image' => $assets . 'welding.jpg', 'icon' => 'fa-fire', 'url' => home_url( '/our-ventures/construction-sector-skills/' ), 'duration' => 'Contact admissions for the current schedule', 'intakes' => 'Confirmed by admissions', 'qualification' => 'Practical MIG/MAG welding training', 'examining' => 'Confirmed for the selected pathway', 'entry' => 'Admissions will advise based on the selected level', 'outcomes' => array( 'Workshop safety', 'MIG/MAG process setup', 'Weld technique and control', 'Quality-aware practical work' ) ),
