...
function eduma_child_legacy_course_catalog() {
	$assets = get_stylesheet_directory_uri() . '/assets/images/courses/';
	return array(
		'welding-and-fabrication' => array( 'title' => 'Welding and Fabrication', 'short' => 'Develop practical workshop skills with industry-aware training and modern learning tools.', 'image' => $assets . 'welding.jpg', 'icon' => 'fa-fire', 'url' => home_url( '/our-ventures/construction-sector-skills/' ), 'duration' => 'Contact admissions for the current schedule', 'intakes' => 'Confirmed by admissions', 'qualification' => 'Practical welding and fabrication training', 'examining' => 'Confirmed for the selected pathway', 'entry' => 'Admissions will advise based on the selected level', 'outcomes' => array( 'Workshop safety', 'Welding processes', 'Metal fabrication', 'Quality-aware practical work' ) ),
...
function eduma_child_get_legacy_course_for_page() {
	...
	return isset( $map[ $slug ], $catalog[ $map[ $slug ] ] ) ? $catalog[ $map[ $slug ] ] : false;
}
