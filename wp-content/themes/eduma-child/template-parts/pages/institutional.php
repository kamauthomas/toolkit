...
<main id="main-content" class="toolkit-page toolkit-institutional-page">
	...
	<section class="toolkit-institutional-intro toolkit-section"><div><p class="toolkit-kicker">The Toolkit for Skills and Innovation</p><h2><?php echo esc_html( $page['section'] ); ?></h2><p><?php echo esc_html( $page['body'] ); ?></p></div><img src="<?php echo esc_url( $page['image'] ); ?>" width="760" height="520" alt="<?php echo esc_attr( $page['section'] ); ?>"></section>
