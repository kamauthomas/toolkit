...
<main id="main-content" class="toolkit-page toolkit-notice-page">
	...
	<section class="toolkit-section toolkit-notices">
		...
		<div class="toolkit-notice-grid">
			<article data-category="admissions" data-date="2026-09-02"><div class="toolkit-notice-card__content"><span class="toolkit-tag">Admissions</span><h2>September intake applications</h2><p>Applications are open for Toolkit’s September 2026 intake. Review the current pathways and use the guided application route.</p><div class="toolkit-notice-card__meta"><span><i class="far fa-calendar" aria-hidden="true"></i> 2 September 2026</span><span><i class="far fa-user-circle" aria-hidden="true"></i> Admissions office</span></div><a href="<?php echo esc_url( $apply_url ); ?>">Start application <i class="fas fa-arrow-right" aria-hidden="true"></i></a></div><img src="<?php echo esc_url( $image ); ?>" width="600" height="400" alt="Toolkit students and graduates"></article>
