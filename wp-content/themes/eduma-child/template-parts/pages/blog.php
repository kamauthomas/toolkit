...
<main id="main-content" class="toolkit-page toolkit-blog-page">
	...
	<section class="toolkit-blog-feature toolkit-section">
		<a href="<?php the_permalink(); ?>"><img src="<?php echo esc_url( $assets . 'impact.jpg' ); ?>" width="780" height="520" alt="<?php echo esc_attr( get_the_title() ); ?>"></a>
