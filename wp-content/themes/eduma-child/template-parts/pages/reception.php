...
<main id="main-content" class="toolkit-page toolkit-reception-page">
	...
	<section class="reception-layout">
		<div class="reception-guide">
			...
			<p class="reception-direct"><strong>Need immediate assistance?</strong><br><a href="tel:+254709549200">Call +254 709 549 200</a><br><a href="https://wa.me/254711802855" target="_blank" rel="noopener noreferrer">WhatsApp +254 711 802 855</a></p>
		</div>
		<div class="reception-card">
			...
			<?php if ( $active ) : ?>
				<form class="reception-form" data-reception-form>
					...
					<label class="reception-consent"><input name="consent" type="checkbox" value="1" required><span>I consent to The Toolkit for Skills and Innovation using these details to manage and follow up on my reception request.</span></label>
					<button type="submit">Send to reception</button>
					<p class="reception-form-status" data-form-status role="status" aria-live="polite"></p>
					<p class="reception-privacy">This form sends your details to The Toolkit for Skills and Innovation’s reception system. It does not check you in; reception records physical arrival separately.</p>
				</form>
			<?php else : ?>
				<p>Online reception is being prepared. Call <a href="tel:+254709549200">+254 709 549 200</a> or WhatsApp <a href="https://wa.me/254711802855" target="_blank" rel="noopener noreferrer">+254 711 802 855</a> for assistance.</p>
			<?php endif; ?>
		</div>
	</section>
</main>
