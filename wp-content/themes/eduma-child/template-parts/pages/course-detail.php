...
<main id="main-content" class="toolkit-page toolkit-course-page toolkit-catalog-course">
	...
	<section class="toolkit-section toolkit-course-data"><div><p class="toolkit-kicker">Course facts</p><h2>Plan your training</h2><p>These details are taken from the Toolkit Admissions Prospectus 2026. Admissions will confirm availability, eligibility, and current costs before enrolment.</p></div><dl><div><dt>Qualification</dt><dd><?php echo esc_html( $course['qualification'] ); ?></dd></div><div><dt>Examining body</dt><dd><?php echo esc_html( $course['examining'] ); ?></dd></div><div><dt>Duration</dt><dd><?php echo esc_html( $course['duration'] ); ?></dd></div><div><dt>Entry requirement</dt><dd><?php echo esc_html( $course['entry'] ); ?></dd></div><?php if ( eduma_child_2026_pricing_enabled() ) : ?><div><dt>Fees</dt><dd><?php echo esc_html( $course['fees'] ); ?></dd></div><?php else : ?><div><dt>Fees</dt><dd>Contact admissions for current fees and available funding options.</dd></div><?php endif; ?><div><dt>Intakes</dt><dd><?php echo esc_html( $course['intakes'] ); ?></dd></div></dl></section>
