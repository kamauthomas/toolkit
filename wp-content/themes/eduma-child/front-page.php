...
<section class="home-testimonials" aria-labelledby="home-testimonials-title"><div class="home-modern__inner">
	...
	<div class="home-testimonials__actions"><a class="home-modern__text-link" href="<?php echo esc_url( home_url( '/testimonials/' ) ); ?>">Hear more learner voices <i class="fas fa-arrow-right" aria-hidden="true"></i></a><a class="home-modern__text-link" href="<?php echo esc_url( home_url( '/graduation/' ) ); ?>">Explore graduation achievements <i class="fas fa-arrow-right" aria-hidden="true"></i></a></div>
</div></section>
