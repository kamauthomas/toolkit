...
- Bootstrap values for this rollout: commit `91cf32b`, version
  `2026.08.10.4` (both demo and production were manually deployed and fully
  verified there on 10 August 2026). The implementation examples below retain
  older fixture values where they are intentionally testing version handling;
  the real bootstrap command must use this current baseline.
